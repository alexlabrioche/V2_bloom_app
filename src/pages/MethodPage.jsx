    ...
    <div>
      <Box margin={{ bottom: "large" }}>
        ...
        <Paragraph fill>
          ...
          européen — a été effectuée par l'équipe de BLOOM. Il ne s’agit ni
          d'une liste exhaustive ni d’un échantillon représentatif (c'est-à-dire
          ...
          importants du point de vue de leur impact sur les écosystèmes marins
          et les pêcheurs. En outre, cette sélection porte principalement sur
          les textes adoptés depuis 2017, pour une raison d'accessibilité des
          données (nous n'avons pas trouvé toutes les données nécessaires pour
          couvrir toute la législature).
        </Paragraph>
        ...
        <Paragraph fill>
          ...
          importance sont votés par "appel nominal", c'est-à-dire qu'un groupe
          de députés demande la publication du détail du vote. Par ailleurs, le
          deuxième critère nous a également permis de nous assurer que les
          députés ne pouvaient ignorer, par le biais des recommandations
          transmises par les ONG, quel vote allait protéger l'océan et quel vote
          allait le détruire.
        </Paragraph>
        <Paragraph fill>
          ...
          restreinte selon 1) les critères décrits ci-dessus et 2) la vision et
          la mission de BLOOM.
        </Paragraph>
        <Paragraph fill>
        ...
        <Ul>
          <ListItem>
            ...
            pour tous les amendements demandés en vote par appel nominal. Ainsi,
            nous avons sélectionné les amendements pour lesquels les ONG avaient
            particulièrement insisté en indiquant un double "+" (voter
            absolument pour) ou un double "-" (voter contre absolument).
          </ListItem>
          <ListItem>
            ...
            sélection a donc été opérée par l'équipe de BLOOM pour ne prendre en
            compte que ceux qui nous semblaient les plus importants, parmi ceux
            déjà doublement marqués.`, `L'accord Japon-Union européenne : seuls
            les amendements 16 et 39 sur le thon rouge et la chasse à la baleine
            ont été sélectionnés. Très peu d'autres amendements traitaient des
        ...
        <Table>
          ...
          <TableBody>
            <TableRow>
              <TableCell scope="row">
                <Bold>Vote protecteur : </Bold>En accord avec les
                recommandations des ONG pour la protection de l'océan (exemples
                : Greenpeace, Seas at Risk et Oceana).
              </TableCell>
            ...
            <TableRow>
              <TableCell scope="row">
                <Bold>Abstention : </Bold>Le député s'est abstenu. Il a donc
            ...
            <TableRow>
              <TableCell scope="row">
                <Bold>Absence : </Bold>Le député n'a voté pour aucun amendement
                ou texte tout le long de la séance de vote. Nous avons donc
                considéré qu'une absence était "plus mauvaise" (car la présence
                est obligatoire) qu'une abstention ("neutre" car n'influence pas
            ...
            <TableRow>
              <TableCell scope="row">
                ...
                mais pour une raison inconnue il n'a pas voté pour cet
        ...
        <Paragraph fill>
          <Bold>NB 1 : </Bold>La note la plus basse de ce barème est
          l’attribution de 0 point aux votes "destructeurs" (pour voir à quoi
          peuvent ressembler des recommandations de vote :&nbsp;
          <Anchor
            target="_blank"
          ...
          entre "abstention" et "vote protecteur" (1 -> 3) qu'entre "abstention"
          et "vote destructeur" (1 -> 0) car nous avons voulu valoriser les
        ...
        <Paragraph fill>
          ...
          la méthode de vote - très rapide - il est compréhensible que des
          erreurs surviennent.
        </Paragraph>
        <Heading level={4}>
        ...
        <Paragraph fill>
          ...
          moyenne pondérée, c'est-à-dire que chaque règlement a reçu le même
          poids dans la note finale, quel que soit le nombre d'amendements
          considérés.
        </Paragraph>
        <Paragraph fill>
          Pour cela, les points de chaque député ont été additionnés pour chaque
          règlement, puis le total a été divisé par le maximum de points
          possible par règlement. Par exemple, pour le Règlement Mesures
          Techniques, six votes ont été pris en compte, le total par député pour
          le Règlement Mesures Techniques a donc été divisé par 18 (6 votes x 3
          points pour chaque vote "protecteur"). Dans le cas de Michèle
          Alliot-Marie, qui a eu deux votes protecteurs et quatre votes
          destructeurs au sein de ce règlement, sa note est donc de :{" "}
          <Bold>(2x3 + 4x0)/18 = 0,3</Bold>
        </Paragraph>
        <Paragraph fill>
        ...
        <Paragraph fill>
          ...
          varie donc en fonction du nombre de texte pour lesquels chaque député
          a pu voter. Par exemple, Louis Aliot a quitté sa fonction de député en
          juillet 2017 et, pour les textes que nous avons pris en compte, n'a
          été actif que pour deux d’entre eux. Ainsi sa note totale a été
          divisée par 10 (=20/2) et les textes pour lesquels il n'a pas pu voter
          n'ont pas été comptabilisés dans sa moyenne. Il entre alors dans la
          catégorie des "inactifs", qui regroupe les députés ayant quitté leurs
          fonctions et n'ayant donc pas une moyenne représentative car trop peu
          de votes ont pu être pris en compte.
        </Paragraph>
        ...
        <Ul>
          <ListItem>
            ...
            allant de 14/20 à 20/20 : + de 70% de leurs votes sont PROTECTEURS
            de l'océan.
          </ListItem>
          <ListItem>
