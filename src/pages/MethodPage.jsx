    ...
    <Page paper goBack title="Méthodologie">
      ...
      <Table>
        ...
        <TableBody>
          <TableRow>
            <TableCell scope="row">
              <Bold color="protect">Vote protecteur : </Bold>En accord avec les
          ...
          <TableRow>
            <TableCell scope="row">
              <Bold color="destruct">Vote destructeur : </Bold>Allant à
              l’encontre des recommandations des ONG.
            </TableCell>
            <TableCell align="right" scope="row">
              <Bold>0</Bold>
            </TableCell>
          ...
          <TableRow>
            <TableCell scope="row">
              <Bold color="medium">Abstention : </Bold>Le député s'est abstenu.
              Il a donc voté mais ne s'est prononcé ni en faveur, ni en défaveur
              de l'objet du vote.
            </TableCell>
            <TableCell align="right" scope="row">
              <Bold>1</Bold>
          ...
          <TableRow>
            <TableCell scope="row">
              <Bold color="absence">Absence : </Bold>Le député n'a voté pour
              aucun amendement ou texte tout le long de la séance de vote. Nous
              avons donc considéré qu'une absence était "plus mauvaise" (car la
              présence est obligatoire) qu'une abstention ("neutre" car
              n'influence pas l'adoption ou non d'un amendement/texte), mais
              meilleure qu'un vote destructeur.
            </TableCell>
            <TableCell align="right" scope="row">
              <Bold>0.5</Bold>
            </TableCell>
          ...
          <TableRow>
            <TableCell scope="row">
              <Bold color="absence">Présent mais n'a pas voté : </Bold>
